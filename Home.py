...
st.header('WebGIS')
st.subheader('Aula SIG - Análise Espacial na Regularização Fundiária e Ambiental')
st.write('')
st.write('')
...
poligono_subido = st.sidebar.file_uploader('Escolha o polígono a ser analisado (CAR)')


embargos = 'dados/embargos/embargos_ibama.parquet'
desmatamentos = 'dados/desmatamentos/prodes.parquet'
...
if poligono_subido:
    ...
    tema_grafico = col1_graf.selectbox('Selecione o tema do gráfico',options=['Desmatamento','Embargo','Terras Indígenas'])
